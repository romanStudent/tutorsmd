...
export default function PrivacyPage() {
    ...
    return (_jsx(Layout, { children: _jsxs("div", { className: "max-w-2xl mx-auto px-4 py-16", children: [_jsx("h1", { className: "text-2xl font-bold text-gray-900 mb-8", children: TITLES[lang] ?? TITLES.de }), _jsx("div", { className: "space-y-6", children: sections.map((s, i) => (_jsxs("div", { children: [_jsx("h2", { className: "text-base font-semibold text-gray-900 mb-2", children: s.title }), _jsx("p", { className: "text-sm text-gray-600 leading-relaxed", children: s.content })] }, i))) }), _jsx("p", { className: "text-xs text-gray-400 mt-12", children: "Stand: Mai 2025 \u00B7 tutorsmd.net" })] }) }));
}
