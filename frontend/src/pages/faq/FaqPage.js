...
const FAQ_MAP = { de: FAQ_DE, ru: FAQ_RU, en: FAQ_EN };
export default function FaqPage() {
    ...
    return (_jsx(Layout, { children: _jsxs("div", { className: "max-w-2xl mx-auto px-4 py-16", children: [_jsx("h1", { className: "text-2xl font-bold text-gray-900 mb-8 text-center", children: titles[lang] ?? titles.de }), _jsx("div", { className: "space-y-2", children: items.map((item, i) => (_jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 overflow-hidden", children: [_jsxs("button", { onClick: () => setOpen(open === i ? null : i), className: "w-full flex items-center justify-between px-5 py-4 text-left\r\n                  text-sm font-medium text-gray-900 hover:bg-gray-50 transition", children: [_jsx("span", { children: item.question }), _jsx("span", { className: `text-gray-400 transition-transform ${open === i ? 'rotate-180' : ''}`, children: "\u25BE" })] }), open === i && (_jsx("div", { className: "px-5 pb-4 text-sm text-gray-600 leading-relaxed border-t border-gray-100 pt-3", children: item.answer }))] }, i))) })] }) }));
}
